...
#if !defined(LUA_USE_MODULES_PWM)
#if defined(LUA_USE_MODULES_PWMLED)
#define MODULES_PWMLED         "pwmled"
#define ROM_MODULES_PWMLED     \
    _ROM(MODULES_PWMLED, luaopen_pwmled, pwmled_map)
#endif
#endif
#ifndef MODULES_PWMLED
#define ROM_MODULES_PWMLED
#endif
